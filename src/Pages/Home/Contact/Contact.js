...
import picture from '../../../assests/images/patient.jpg'
const Contact = () => {
  return (
    <div className="relative mt-10">
      <img
        src={picture} className="absolute inset-0 object-cover w-full h-full"
        alt=""
      />
          ...
          <div className="flex flex-col items-center justify-between xl:flex-row">
            <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
              ...
              <p className="max-w-xl mb-4 text-base text-white md:text-lg">
                Stay connected with us for more update regarding availability of doctor, discount and much more
              </p>
              <Link to="/" aria-label="" className="inline-flex items-center font-semibold text-white underline">
                Learn more
